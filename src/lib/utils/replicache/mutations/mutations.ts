...
import mutationsExerciseTypeUpdate from "./exerciseType/mutationsExerciseTypeUpdate";

export type M = typeof mutators;

export const mutators = {
  createExercise: (tx: WriteTransaction, args: ExerciseFull) =>
    mutationsExerciseCreate({ tx, args }),
  deleteExercise: (tx: WriteTransaction, args: ExerciseFull) =>
    mutationsExerciseDelete({ tx, args }),
  createExerciseSet: (
    tx: WriteTransaction,
    args: { exercise: ExerciseFull; exerciseSet: ExerciseSet }
  ) => mutationsExerciseSetCreate({ tx, args }),
  deleteExerciseSet: (
    tx: WriteTransaction,
    args: { exercise: ExerciseFull; exerciseSet: ExerciseSet }
  ) => mutationsExerciseSetDelete({ tx, args }),
  createSession: (tx: WriteTransaction, args: WorkoutSession) =>
    mutationsSessionCreate({ tx, args }),
  updateSession: (tx: WriteTransaction, args: WorkoutSession) =>
    mutationsSessionUpdate({ tx, args }),
  deleteSession: (tx: WriteTransaction, args: WorkoutSession) =>
    mutationsSessionDelete({ tx, args }),
  getSessions: (tx: ReadTransaction, args: { userId: string }) =>
    mutationsSessionsGet({ tx, args }),
  updateUserSettings: (tx: WriteTransaction, args: Settings) =>
    mutationsUserSettingsUpdate({ tx, args }),
  createExerciseType: (
    tx: WriteTransaction,
    args: { exerciseType: ExerciseType; userId: string }
  ) => mutationsExerciseTypeCreate({ tx, args }),
  updateExerciseType: (
    tx: WriteTransaction,
    args: { exerciseType: Partial<ExerciseType>; userId: string }
  ) => mutationsExerciseTypeUpdate({ tx, args }),
  deleteExerciseType: (
    tx: WriteTransaction,
    args: { exerciseType: ExerciseType; userId: string }
  ) => mutationsExerciseTypeDelete({ tx, args }),
  createUserWorkoutSessionTemplate: (
    tx: WriteTransaction,
    args: WorkoutSessionTemplateWithExerciseTypes
  ) => mutationsUserWorkoutSessionTemplatesCreate({ tx, args }),
  updateUserWorkoutSessionTemplate: (
    tx: WriteTransaction,
    args: Partial<WorkoutSessionTemplateWithExerciseTypes>
  ) => mutationsUserWorkoutSessionTemplatesUpdate({ tx, args }),
};

...
// Mutations
const mutationsExerciseTypeCreate = async ({ tx, args }: { tx: WriteTransaction, args: { exerciseType: ExerciseType, userId: string } }) => {
    ...
    return await tx.put(key, JSON.stringify({ ...args.exerciseType }))
}
